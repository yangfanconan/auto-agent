...
class TaskPanel:
    ...
    def create_error(self, error: str,
                     suggestion: Optional[str] = None) -> Panel:
        """创建错误面板"""
...
class StatusTable:
    ...
    def create_environment_table(self, env_report: Dict) -> Table:
        ...
        # Python
        python_status = "[green]✅[/green]" if env_report.get(
            "python_version") else "[red]❌[/red]"
        table.add_row(
            "Python",
            python_status,
        ...
        # Git
        git_status = "[green]✅[/green]" if env_report.get(
            "git_version") else "[yellow]⚠️[/yellow]"
        table.add_row(
            "Git",
            git_status,
