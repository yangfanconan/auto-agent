...
class TestCoreClassesInstantiation:
    ...
    def test_auto_agent_instantiation(
            self, mock_tracker_class, mock_get_logger, temp_workspace):
        """测试 AutoAgent 实例化"""
...
class TestModulesClassesInstantiation:
    ...
    def test_environment_manager_instantiation(
    ...
    def test_test_runner_instantiation(
            self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试 TestRunner 实例化"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    def test_delivery_manager_instantiation(
...
class TestIntegration:
    ...
    def test_full_workflow_mock(
            self, mock_parser_logger, mock_tracker_class, mock_scheduler_logger, temp_workspace):
        """测试完整工作流程（使用 Mock）"""
        mock_logger = MagicMock()
