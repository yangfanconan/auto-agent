...
class TestEnvironmentManager:
    ...
    def test_manager_initialization(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试管理器初始化"""
    ...
    def test_scan_environment(self, mock_sys, mock_platform, mock_get_tool, mock_get_logger, temp_workspace):
        """测试扫描环境"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_check_command_success(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试检查命令成功"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_check_command_failure(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试检查命令失败"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_check_command_exception(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试检查命令异常"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_fix_environment(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试修复环境"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_install_package_success(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试安装包成功"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_install_package_failure(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试安装包失败"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_setup_task_handler(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试任务处理器接口"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_check_python_dependencies(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试检查 Python 依赖"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
        ...
        with patch('builtins.__import__') as mock_import:
            ...
            manager._check_python_dependencies(components, issues, recommendations)
            
            assert len(components) > 0
    
    @patch('modules.environment.get_logger')
    @patch('modules.environment.get_tool')
    def test_check_project_dependencies(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试检查项目依赖"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
        ...
        manager._check_project_dependencies(components, issues, recommendations)
