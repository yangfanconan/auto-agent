...
class TestCodeGenerator:
    ...
    def test_generator_initialization(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试生成器初始化"""
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_basic_framework_python(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试生成 Python 基础框架"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_basic_framework_javascript(self, mock_get_tool, mock_get_logger, temp_workspace):
        ...
        code = generator._generate_basic_framework("Test function", "javascript")
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_basic_framework_other(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试生成其他语言基础框架"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_extract_code_from_output(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试从输出提取代码"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
...
```'''
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_extract_code_no_block(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试没有代码块时返回原内容"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_success(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试生成代码成功"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_with_output_dir(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试指定输出目录生成"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
        ...
        with patch.object(generator, '_generate_with_opencode') as mock_gen:
            ...
            result = generator.generate("测试", "python", output_dir=str(output_dir))
            
            assert result.success is True
    
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_failure(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试生成代码失败"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_with_opencode_success(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试使用 opencode 生成成功"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_with_qwencode(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试使用 qwencode 生成"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_module(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试生成模块"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
        ...
        with patch.object(generator, 'generate') as mock_gen:
            mock_gen.return_value = CodeGenerationResult(
                success=True,
                files=[CodeFile(path="test.py", content="code", language="python")]
            )
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_refactor_code(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试重构代码"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_get_generated_files(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试获取已生成文件列表"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_task_handler(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试任务处理器接口"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
    ...
    @patch('modules.code_generator.get_logger')
    @patch('modules.code_generator.get_tool')
    def test_generate_task_handler_failure(self, mock_get_tool, mock_get_logger, temp_workspace):
        """测试任务处理器失败"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
        mock_get_tool.return_value = None
