...
class TestStatusTable:
    ...
    def test_create_subtasks_table(self):
        ...
        table = StatusTable()
        subtasks = [
            {"name": "任务 1", "status": "completed", "task_type": "code_generation", "progress": 100},
            {"name": "任务 2", "status": "in_progress", "task_type": "testing", "progress": 50},
            {"name": "任务 3", "status": "pending", "task_type": "git_operation", "progress": 0},
        ]
