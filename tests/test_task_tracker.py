...
class TestTaskTracker:
    ...
    @patch('core.task_tracker.get_logger')
    def test_register_plan(self, mock_get_logger,
                           temp_workspace, sample_task_plan):
        """测试注册任务计划"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_start_task(self, mock_get_logger,
                        temp_workspace, sample_task_plan):
        """测试开始任务"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_start_subtask(self, mock_get_logger,
                           temp_workspace, sample_task_plan):
        """测试开始子任务"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_update_subtask_progress(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试更新子任务进度"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_update_subtask_progress_clamp(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试进度值范围限制"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_complete_subtask(self, mock_get_logger,
                              temp_workspace, sample_task_plan):
        """测试完成子任务"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_fail_subtask(self, mock_get_logger,
                          temp_workspace, sample_task_plan):
        """测试子任务失败"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_complete_plan(self, mock_get_logger,
                           temp_workspace, sample_task_plan):
        """测试完成任务计划"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_fail_plan(self, mock_get_logger,
                       temp_workspace, sample_task_plan):
        """测试任务计划失败"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_get_events(self, mock_get_logger,
                        temp_workspace, sample_task_plan):
        """测试获取事件列表"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_get_progress_report_non_existent(
            self, mock_get_logger, temp_workspace):
        """测试获取不存在计划的进度报告"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_generate_briefing_non_existent(
            self, mock_get_logger, temp_workspace):
        """测试生成不存在计划的简报"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_get_subtask(self, mock_get_logger,
                         temp_workspace, sample_task_plan):
        """测试获取子任务"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_operations_on_non_existent_plan(
            self, mock_get_logger, temp_workspace):
        """测试对不存在计划的安全操作"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_subtask_actual_duration_calculation(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试子任务实际耗时计算"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_add_event_to_non_existent_plan(
            self, mock_get_logger, temp_workspace):
        """测试向不存在的计划添加事件"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_load_plan_with_full_data(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试加载完整的计划数据"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_get_subtask_not_found(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试获取不存在的子任务"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_progress_report_with_failed_subtasks(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试包含失败子任务的进度报告"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_briefing_with_various_statuses(
            self, mock_get_logger, temp_workspace, sample_task_plan):
        """测试各种状态的任务简报"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
    ...
    @patch('core.task_tracker.get_logger')
    def test_start_subtask_non_existent_plan(
            self, mock_get_logger, temp_workspace):
        """测试对不存在的计划开始子任务"""
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger
